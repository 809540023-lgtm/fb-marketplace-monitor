...
class AnalyticsService:
    def __init__(self, store, recruiting_service: RecruitingService, ai_runtime: SchoolPlatformAiRuntime) -> None:
        self.store = store
...
class NotificationService:
    ...
    def drain_queued_notifications(self, limit: int = 50) -> list[NotificationRecord]:
        ...
        return [self.dispatch_notification(item.id) for item in queued]
